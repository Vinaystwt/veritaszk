  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      >
        ...
        <h1 style={{ fontSize: "48px", fontWeight: 700, marginBottom: "16px" }}>Verifier Portal</h1>
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "18px", lineHeight: 1.7 }}>Enter any organization address to verify their solvency proof.</p>
      </motion.div>
    </div>
  );
}
