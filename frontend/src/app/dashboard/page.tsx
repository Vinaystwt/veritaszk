  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      >
        ...
        <h1 style={{ fontSize: "48px", fontWeight: 700, marginBottom: "16px" }}>Public Dashboard</h1>
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "18px", lineHeight: 1.7 }}>Browse all verified solvency proofs on Aleo Testnet.</p>
      </motion.div>
    </div>
  );
}
